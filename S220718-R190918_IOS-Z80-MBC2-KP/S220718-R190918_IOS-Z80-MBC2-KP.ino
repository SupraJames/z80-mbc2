...
S220718-R190918 - HW ref: A040618
...
#define   IODIRB_REG    0x10  // MCP23017 internal register IODIRB  (see datasheet)
#define   GPPUA_REG     0x06  // MCP23017 internal register GPPUA  (see datasheet)
#define   GPPUB_REG     0x16  // MCP23017 internal register GPPUB  (see datasheet)
#define   GPIOA_REG     0x09  // MCP23017 internal register GPIOA  (see datasheet)
#define   GPIOB_REG     0x19  // MCP23017 internal register GPIOB  (see datasheet)
...
// ------------------------------------------------------------------------------
  ...
  Serial.begin(9600);
  Serial.println(F("\r\n\nZ80-MBC2 - A040618\r\nIOS - I/O Subsystem - S220718-R190918\r\n"));
  ...
  //   or an invalid bootMode code was read from internal EEPROM
  {
    ...
    printOsName(diskSet);
    Serial.println("\r\n 4: Autoboot");
    Serial.println(" 5: iLoad");
    Serial.print(" 6: Change Z80 clock speed (->");
